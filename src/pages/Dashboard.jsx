...
import { fetchDashboardSummary, fetchLeads, fetchCurrentUsers } from '../services/leadService';
...
export default function Dashboard() {
  ...
  const [tasks, setTasks] = useState([
    { id: 1, text: 'Follow-up Call with active leads', date: 'Tomorrow', priority: 'High', completed: false },
    { id: 2, text: 'Email proposal draft to prospective client', date: 'Tomorrow', priority: 'Normal', completed: false },
    { id: 3, text: 'Schedule Technical Demo session', date: 'Upcoming', priority: 'High', completed: true },
    { id: 4, text: 'Review Negotiation contract terms', date: 'This Week', priority: 'Urgent', completed: false }
  ]);
